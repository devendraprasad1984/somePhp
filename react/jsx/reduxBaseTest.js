...
const createPolocy=(name, amount)=>{
    return {
...
store.dispatch(createPolocy('dp',200))
store.dispatch(createPolocy('dp1',400))
store.dispatch(createPolocy('dp2',500))
